...
const styles = StyleSheet.create({ card: { flex: 1, maxWidth: '48.5%', borderRadius: radius.md, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.border, overflow: 'hidden', shadowColor: colors.green, shadowOpacity: .07, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 2 }, pressed: { opacity: .88, transform: [{ scale: .985 }] }, media: { height: 150, backgroundColor: colors.greenSoft, alignItems: 'center', justifyContent: 'center' }, image: { width: '100%', height: '100%' }, placeholder: { color: colors.green, fontWeight: '900', fontSize: 19 }, body: { padding: 12, gap: 5 }, name: { color: colors.ink, fontWeight: '800', minHeight: 40, lineHeight: 19 }, shop: { color: colors.muted, fontSize: 12 }, rating: { fontSize: 12 }, stars: { color: colors.star, fontSize: 12, letterSpacing: 0.5 }, reviewCount: { color: colors.muted, fontSize: 11 }, price: { color: colors.green, fontWeight: '900', fontSize: 16, marginTop: 2 } })
