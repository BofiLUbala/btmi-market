...
const styles=StyleSheet.create({page:{padding:spacing.md,gap:spacing.md},stars:{color:colors.star,fontSize:20},kind:{fontWeight:'900',color:colors.ink},comment:{color:colors.ink,marginVertical:6},muted:{color:colors.muted}})
