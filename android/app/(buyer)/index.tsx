...
export default function HomeScreen() {
  ...
  const header = <>
    <View style={styles.topbar}>
      <View style={styles.brandRow}><View style={styles.logo}><Text style={styles.logoText}>TBK</Text></View><View><Text style={styles.brand}>TBK</Text><Text style={styles.tagline}>Simple et rapide</Text></View></View>
...
const styles = StyleSheet.create({
  ...
  brandRow: { flexDirection: 'row', alignItems: 'center', gap: 11 }, logo: { width: 39, height: 39, borderRadius: 19.5, backgroundColor: colors.ink, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: colors.white }, logoText: { color: colors.white, fontSize: 12, fontWeight: '900', letterSpacing: 0.5 }, brand: { color: colors.ink, fontSize: 17, fontWeight: '900' }, tagline: { color: colors.muted, fontSize: 11, marginTop: 1 }, iconButton: { width: 42, height: 42, borderRadius: 21, backgroundColor: colors.greenSoft, alignItems: 'center', justifyContent: 'center' },
