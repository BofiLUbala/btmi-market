...
export default function RootLayout() {
  ...
  return <QueryClientProvider client={queryClient}><StatusBar style="light"/><Stack screenOptions={{ headerStyle: { backgroundColor: colors.green }, headerTintColor: colors.white, headerTitleStyle: { fontWeight: '800' }, contentStyle: { backgroundColor: colors.cream } }}><Stack.Screen name="index" options={{ headerShown: false }}/><Stack.Screen name="(buyer)" options={{ headerShown: false }}/><Stack.Screen name="auth/login" options={{ title: 'Connexion' }}/><Stack.Screen name="products/[id]" options={{ title: 'Produit' }}/><Stack.Screen name="orders/index" options={{ title: 'Mes commandes' }}/><Stack.Screen name="orders/[id]" options={{ title: 'Commande' }}/><Stack.Screen name="reviews/index" options={{ title: 'Mes avis' }}/><Stack.Screen name="reviews/write" options={{ title: 'Publier un avis' }}/><Stack.Screen name="seller" options={{ headerShown: false }}/></Stack></QueryClientProvider>
}
