...
const makeStyles = (colors: Colors) => StyleSheet.create({page:{padding:spacing.md,gap:spacing.md},muted:{color:colors.muted,lineHeight:21},success:{color:colors.success,fontWeight:'800',lineHeight:21}})