...
export default function SellerLayout() {
  ...
  return <Stack screenOptions={{ headerStyle: { backgroundColor: colors.green }, headerTintColor: colors.white, headerTitleStyle: { fontWeight: '900' }, headerRight: () => <PreferenceToggleButtons /> }}><Stack.Screen name="index" options={{ title: t('seller.workspace') }}/><Stack.Screen name="orders" options={{ title: t('seller.ordersByShop') }}/><Stack.Screen name="reviews" options={{ title: t('seller.customerReviews') }}/></Stack>
}