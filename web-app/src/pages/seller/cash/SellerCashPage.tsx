...
export default function SellerCashPage() {
  ...
  useEffect(() => {
    if (activeBusiness) void loadCashData()
  }, [activeBusiness, activeShop, loadCashData])

  // Poll while the tab is visible, and refresh the moment it becomes visible again.
  useEffect(() => {
    if (!activeBusiness) return
    function startPolling() {
      stopPolling()
      intervalRef.current = setInterval(() => void loadCashData(true), POLL_INTERVAL)
    }
  ...
  return (
    <div className="seller-cash">
      ...
      <div className="live-bar">
        ...
        <button className="refresh-btn" onClick={() => void loadCashData()} disabled={refreshing}>
